...
export function EmbedButton({ mapId }: { mapId: string }) {
  ...
  const snippet = `<iframe src="${typeof window !== "undefined" ? window.location.origin : "https://idomap.com"}/embed/${mapId}" width="100%" height="450" style="border:none;border-radius:8px" allowfullscreen></iframe>`;
