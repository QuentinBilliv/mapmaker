  ...
  return (
    <section className="bg-white py-20 md:py-28 border-t border-black/5">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-base text-[#1a1a1a]/50 max-w-xl mb-14">
          From classroom handouts to published articles — idomaps adapts to how you work.
        </p>
    ...
    <section className="bg-white py-20 md:py-28 border-t border-black/5">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-base text-[#1a1a1a]/50 max-w-xl mb-8">
          This is a real map made with idomaps. Zoom, pan, and hover to explore.
        </p>
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/5 py-8">
      <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="text-xs text-white/20">&copy; {new Date().getFullYear()} idomaps</span>
